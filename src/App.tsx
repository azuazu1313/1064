...
function App() {
  ...
  const galleryImages = [
    {
      webp: "https://i.postimg.cc/KjW7D4RC/UNrNrlx.webp",
      fallback: "https://i.imgur.com/UNrNrlx.jpeg"
    },
    {
      webp: "https://i.postimg.cc/LXHVHrcQ/MjZLRzf.webp",
      fallback: "https://i.imgur.com/MjZLRzf.jpeg"
    },
    {
      webp: "https://i.postimg.cc/RZHdG11d/g9tQnUQ.webp",
      fallback: "https://i.imgur.com/g9tQnUQ.jpeg"
    },
    {
      webp: "https://i.postimg.cc/j22Qfydz/Qqyucu5.webp",
      fallback: "https://i.imgur.com/Qqyucu5.jpeg"
    },
    {
      webp: "https://i.postimg.cc/FRDV1Tmr/mv0kAOy.webp",
      fallback: "https://i.imgur.com/mv0kAOy.jpeg"
    },
    {
      webp: "https://i.postimg.cc/Qd1gc8sn/7V1nm03.webp",
      fallback: "https://i.imgur.com/7V1nm03.jpeg"
    },
    {
      webp: "https://i.postimg.cc/2832LNVP/DX071gk.webp",
      fallback: "https://i.imgur.com/DX071gk.jpeg"
    },
    {
      webp: "https://i.postimg.cc/rpGJ28Pt/lEB0fxL.webp",
  ...
  useEffect(() => {
    // Set a timeout to load the map after the page has fully loaded
    const timeoutId = setTimeout(() => {
      setShouldLoadMap(true);
    }, 3000); // Delay map loading by 3 seconds

    // Set up intersection observer to load the map when it comes into view
    ...
    <div className="min-h-screen bg-[#FCF2CC] text-black flex flex-col">
      ...
      >
        <div className="container mx-auto py-4 flex flex-col items-center">
          <picture>
            <source srcSet="https://i.postimg.cc/s2zYckgf/8fXsCd4.webp" type="image/webp" />
            <img 
      ...
      <div className="relative w-full md:h-[56.25vw] h-screen">
        <picture className="hidden md:block">
          <source srcSet="https://i.postimg.cc/BnVJN93W/hero2222.webp" type="image/webp" />
          <img 
            src="https://i.imgur.com/zo1XeHz.jpeg" 
            alt="1064 Jewelry Banner Desktop" 
            className="w-full h-full object-cover"
          />
        </picture>
        <picture className="md:hidden">
          <source srcSet="https://i.postimg.cc/wTtQT5rz/XPaWPKv.webp" type="image/webp" />
          <img 
            src="https://i.imgur.com/XPaWPKv.jpeg" 
            alt="1064 Jewelry Banner Mobile" 
            className="w-full h-full object-cover"
          />
        </picture>
        <div className="absolute bottom-8 md:bottom-16 left-1/2 transform -translate-x-1/2">
          <ChevronDown 
            size={32} 
      ...
      <div ref={brandRef} className="py-8 px-4 bg-[#FCF2CC]">
      ...
      <div className="bg-[#FCF2CC]">
        <div className="max-w-3xl mx-auto">
          <div className="h-[100px] md:h-[130px] w-full flex items-center justify-center">
            <GooeyText
              texts={[
                { text: "Höj din smyckessamling", mobileSize: "42px", desktopSize: "63px" },
                { text: "med skräddarsydd design", mobileSize: "41px", desktopSize: "62px" },
                { text: "lika unik som du.", mobileSize: "51px", desktopSize: "76px" },
                { text: "Låt oss skapa", mobileSize: "57px", desktopSize: "84px" },
                { text: "något oförglömligt", mobileSize: "48px", desktopSize: "72px" },
                { text: "din historia", mobileSize: "66px", desktopSize: "99px" },
                { text: "förtjänar att glänsa.", mobileSize: "50px", desktopSize: "74px" }
              ]}
              morphTime={1}
              cooldownTime={3}
      ...
      <div ref={butikRef} className="py-16 px-4 bg-[#FCF2CC]">
        <div ref={mapContainerRef} className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          {shouldLoadMap ? (
            <iframe 
              ...
              title="1064 Jewelry Store Location"
              className="mb-8"
            ></iframe>
          ) : (
            <div className="w-full h-[450px] border-[4px] border-[#B48406] mb-8 overflow-hidden">
              <picture>
                <source 
                  srcSet="https://i.postimg.cc/G2Hq0mXQ/Screenshot-2025-04-02-214516.webp" 
                  media="(min-width: 768px)" 
                  type="image/webp" 
                />
                <source 
                  srcSet="https://i.postimg.cc/0QDFp7tK/photo-2025-04-02-21-54-09.webp" 
                  type="image/webp" 
                />
                <img
                  src="https://i.postimg.cc/G2Hq0mXQ/Screenshot-2025-04-02-214516.webp"
                  alt="1064 Jewelry Store Map Preview"
                  className="w-full h-full object-cover"
                />
              </picture>
            </div>
      ...
      <div ref={omOssRef} className="py-16 px-4 bg-white flex justify-center">
        <div className="container mx-auto text-center">
          <div className="flex flex-col items-center">
            <picture>
              <source srcSet="https://i.postimg.cc/Yv8YGC5n/FWnwX6j.webp" type="image/webp" />
              <img
            ...
            <div className="flex space-x-6">
              <a 
                href="https://www.instagram.com/1064jewelry/" 
                target="_blank" 
              ...
              <a 
                href="https://www.facebook.com/1064jewelry/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-black flex items-center justify-center text-white hover:bg-[#B48406] transition-colors duration-300"
